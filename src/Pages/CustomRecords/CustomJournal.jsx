...
import "../../components/TableComponents/Popups/Popup.css";
...
function CustomRecords({ isCustomEdge }) {
  ...
  const renderTradeCell = (trade, col, index) => {
    const cellStyle = {
      ...
      color: col.textColor || textColor, // Apply text color
    };
  ...
  return (
    <>
      <Editor />
      <Sidebar pageActive={isCustomEdge ? "customedge" : "customjournal"} />
      <div>
        <DateHeader />
      </div>
            ...
            <div className="trade-journal-heading-summary-container">
              <div className="trade-journal-heading-container">
                <img
                  ...
                  src={
                    isCustomEdge
                      ? "SidebarIcons/edge.png"
                      : "SidebarIcons/trading-analysis.png"
                  }
                  alt="Adaptive Edge"
                />
                <img
                  className="sidebar-customize-icons"
                  style={{ marginBottom: isCustomEdge ? " -25px" : "-15px" }}
              ...
              {dynamicColumns.length === 0 ? (
                <div className="no-columns-message">
                  ...
                  >
                    ...
                    <br />
                    2. Choose between Text Input or Dropdown type
                    <br />
                    3. Name your column and set it up
                    <br />
                    4. Add entries to start tracking your data
                  </p>
                </div>
              ) : (
